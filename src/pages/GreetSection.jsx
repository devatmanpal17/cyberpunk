...
export default function GreetSection() {
  return (
    <section className="flex flex-col md:flex-row items-center p-6 md:p-12 lg:p-16 bg-transparent gap-8 md:gap-14 relative overflow-hidden">
      <div className="flex-1 w-full">
        <h2 className="font-exo text-4xl md:text-5xl lg:text-6xl font-extrabold leading-[1.12] text-white mb-6 tracking-tight">
          Greetings! Dive<br />
          into the Cybernetic<br />Universe
        </h2>
        <p className="font-rajdhani text-base md:text-lg text-[#afadad] leading-relaxed max-w-sm font-normal">
